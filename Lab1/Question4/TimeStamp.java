...
{
	public static class TimeStampMapper extends Mapper<LongWritable,Text,Text,IntWritable>
	{
	...
	public static class TimeStampReducer extends Reducer<Text,IntWritable,Text,IntWritable> 
	{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		Job job = Job.getInstance(conf,"TimeStamp");
